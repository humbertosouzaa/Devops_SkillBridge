...
import com.example.skill_bridge.service.CourseService;
...
public class CourseController {
    ...
    @GetMapping
    public ResponseEntity<Page<Course>> all(Pageable p) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Void> update(@PathVariable Long id, @Valid @RequestBody Course c) {
        service.update(id, c);
